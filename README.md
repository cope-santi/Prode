...
* `.github/workflows/post_match_sync.yml` corre barridos durante las ventanas de partidos de fase de grupos: publica predicciones pocos minutos despues del inicio y vuelve a intentar cerca/finalizado el partido para aplicar puntos.
* Para cambiar la frecuencia, editar el cron del workflow. En plan gratis conviene evitar intervalos mas agresivos para no agotar la cuota diaria de Firestore.
